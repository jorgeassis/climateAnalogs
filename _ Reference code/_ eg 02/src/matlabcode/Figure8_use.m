...
hold on;
[C1, h1] = m_contourf (X, Y, Z2, [-2:0.5:10], 'LineStyle', 'none' );

m_gshhs_i('patch',[.7 0.7 .7]);

caxis([0 9]);
clear('X', 'Y', 'Z1', 'Z2', 'C1,', 'h1');

%% 
han02 = subplot(3,2,2);

load data/plot1_data_2;
...
load data/plot1_data_3;

m_proj('Mollweide','lon',[20 380], 'lat',[-90 90]);
m_grid('xtick',[20:360:380], 'xticklabel', '', 'ytick',[-90:30:90],'yticklabel', '','tickdir','out','FontName', 'Times New Roman', 'fontsize', 10, 'linestyle', ':');
hold on;
[C3, h3] = m_contourf (X, Y, Z2, [-2:0.5:10], 'LineStyle', 'none' );
...
han_cb=colorbar('southoutside', 'YTick', [0:1:9], 'FontName', 'Times New Roman', 'FontSize', 14, 'TickDirection', 'out');
...
% text:
text(-4.2, 6.20,  'A) 1800 climates disappearing in 2000', 'FontName', 'Times New Roman', 'Fontsize', 14); 
text( 0.3, 6.20,  'B) Novel climates in 2000 since 1800', 'FontName', 'Times New Roman', 'Fontsize', 14); 
text(-4.2, 3.70,  'C) 2000 climates disappearing in 2100 RCP 4.5', 'FontName', 'Times New Roman', 'Fontsize', 14); 
text( 0.3, 3.70,  'D) Novel climates in 2100 RCP 4.5 since 2000', 'FontName', 'Times New Roman', 'Fontsize', 14); 
text(-4.2 , 1.2,  'E) 2000 climates disappearing in 2100 RCP 8.5', 'FontName', 'Times New Roman', 'Fontsize', 14); 
text( 0.3,  1.2,  'F) Novel climates in 2100 RCP 8.5 since 2000', 'FontName', 'Times New Roman', 'Fontsize', 14); 

text( -1, -2.0,  'Sigma dissimiliarity', 'FontName', 'Times New Roman', 'Fontsize', 16); 
